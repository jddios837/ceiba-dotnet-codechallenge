...
namespace Api.Test
{
    public abstract class IntegrationTestBuilder : IDisposable
    {
        ...
        private readonly CustomWebApplicationFactory<PruebaIngresoBibliotecario.Api.Startup> _appFactory;

        protected IntegrationTestBuilder(){
            // BootstrapTestingSuite();
            Disposed = false;
            _appFactory = new CustomWebApplicationFactory<PruebaIngresoBibliotecario.Api.Startup>();
